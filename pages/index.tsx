...
import getLocationAddress, { API_GET_LOCATION_ADDRESS_KEY } from 'src/api/getLocationAddress';
...
const Home: NextPage = () => {
    ...
    useEffect(
        ...
        [isResetPosition, location?.latitude, location?.longitude, position.coords.x, setPosition],
    );
    ...
    return (
        <Container>
            <DefaultHeader
                centerArea={<HomeHeader.CenterArea onClick={onClickPosition} position={position} />}
